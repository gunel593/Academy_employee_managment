...
//public class TokeBaseSecurityBeanCongfig {
//    private final UserMyBatis userMybatis;
//
//    @Bean
//    public UserDetailsService userDetailsService(){
//        return username -> userMybatis.findByUsername(username).orElseThrow(()->new UsernameNotFoundException("User not found in db"));
//    }
//    @Bean
